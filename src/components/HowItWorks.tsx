...
const Step: React.FC<{ icon: React.ReactNode; title: string; children: React.ReactNode; stepNumber: number }> = ({ icon, title, children, stepNumber }) => (
  <div className="relative flex flex-col items-center text-center">
    <div className="flex items-center justify-center w-16 h-16 bg-white border border-gray-200 rounded-full mb-4 shadow-sm">
        {icon}
    </div>
    <h3 className="text-xl font-bold text-gray-900 mb-2">Step {stepNumber}: {title}</h3>
