...
const FeatureCard: React.FC<{ icon: React.ReactNode; title: string; children: React.ReactNode }> = ({ icon, title, children }) => (
    <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
        <div className="mb-4 inline-block p-3 bg-brand-teal/10 rounded-lg">
            {icon}
        </div>
  ...
  return (
    <section id="features" className="py-20 sm:py-28 container mx-auto px-4">
      <div className="text-center mb-16">
        <h2 className="text-4xl md:text-5xl font-extrabold tracking-tighter text-gray-900">Your New Superpowers</h2>
        <p className="max-w-2xl mx-auto mt-4 text-lg text-gray-600">NymAI equips you with the tools to navigate the digital world with clarity and confidence.</p>
      </div>
